...
import { IUpdatePasswordInputRoot, IUpdatePasswordPayloadRoot } from "../models/userServicesInterface";
...
const useMutateEditPassword = (
  ...
  const updatePassword = async (payload: IUpdatePasswordInputRoot, id: string) => {
